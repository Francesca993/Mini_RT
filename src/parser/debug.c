...
/*   Updated: 2025/10/21 23:52:56 by francesca        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void debug_print_scene(const t_scene *scene_ptr, const char *title)
{
	...
	printf("intensity: %.6f\n", scene_ptr->amb.intensity);
	debug_print_color_255("color:", scene_ptr->amb.color);
	printf("\n");
	...
	debug_print_vector("pos", scene_ptr->light.position);
	printf("intensity: %.6f\n", scene_ptr->light.intensity);
	debug_print_color_255("color: ", scene_ptr->light.color);
	printf("\n");
